...
$query="select * from user_event where accepted='no'";
...
if(isset($_POST['delete_btn']))
{
	$id = $_POST['hidden_id1'];
	echo $id;
	$query2="delete from user_event where id = '$id'";
...
<nav class="navbar navbar-inverse" style="height: 10%;">
  <div class="container-fluid" style="margin-top: 0.6%;font-size: 110%;">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="active"><a href="suggestions.php"><span class="glyphicon glyphicon-send"></span> Suggestions</a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">DELETE <i class="fa fa-trash" aria-hidden="true"></i></h5>
...
<label>Description: </label><span id="descr"> <?php echo $rows['descr'];?></span><br><br>
...
//for delete button
  ...
  document.getElementById('hidden_id1').value=id;
}
